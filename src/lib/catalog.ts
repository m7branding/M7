...
export const CATALOG: Category[] = [
  ...
  // ========================================================== WEBSHOP
  {
    ...
    packages: [
      ...
      {
        id: "shop-bnpl",
        name: "Achteraf betalen & BNPL",
        tagline: "Klarna, in3 of Riverty.",
        kind: "item",
        price: { setup: 395 },
        features: [
          "Aanvraag & aansluiting begeleid",
          "Risico- en landregels ingesteld",
          "Betaalbadges op product en checkout",
          "Afstemming met je boekhouding",
        ],
      },
      {
        id: "shop-analytics",
      ...
      {
        id: "shop-returns",
        name: "Retourportaal & RMA-flow",
        tagline: "Retouren zonder mailwisseling.",
        kind: "item",
        price: { setup: 850 },
        features: [
          "Zelfservice-retour vanuit het account",
          "Retourlabels automatisch aangemaakt",
          "Statussen & terugbetaling bijgehouden",
          "Retourredenen rapporteerbaar",
        ],
      },
      {
        id: "shop-tax",
      ...
      {
        id: "shop-marketplace",
        name: "Marktplaats-koppeling",
        tagline: "Ook verkopen op bol. of Amazon.",
        kind: "item",
        price: { setup: 950, from: true },
        features: [
          "Channable of directe API-koppeling",
          "Assortiment & prijzen uitsturen",
          "Orders centraal binnen in je shop",
          "Voorraad over kanalen bewaakt",
        ],
        recommends: ["paid"],
      },
      {
